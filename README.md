...
**[Try the interactive demo](https://neo.github.io/claude-gate/)** — no install needed, runs in your browser.
...
Open `demo.html` locally, or visit the [live demo](https://neo.github.io/claude-gate/).
